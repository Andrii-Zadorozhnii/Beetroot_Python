...
# З допомогою якої функції можна отримати цей порядок ?
# Реалізуйте наслідування згідно схеми в рис.4. В кожного класу – однаковий атрибут description_attr, що містить ім“я класу, наприклад description_attr = „class A“. Перевірте порядок пошуку атрибутів, закоментовуючи цей атрибут, починаючи від класу А.
